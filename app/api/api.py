...
def login():
    #try prevents an error if the user variable is missing. Try and except are used to tell the user that something went wrong instead of them recieving a syntax error
    try:
